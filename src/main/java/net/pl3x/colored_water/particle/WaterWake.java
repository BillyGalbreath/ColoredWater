...
public class WaterWake extends WaterParticle {
    public WaterWake(World world, double x, double y, double z, double speedX, double speedY, double speedZ) {
    ...
    public static class Factory implements IParticleFactory {
        public Particle createParticle(int particleID, @Nonnull World world, double x, double y, double z, double speedX, double speedY, double speedZ, @Nonnull int... params) {
            return new WaterWake(world, x, y, z, speedX, speedY, speedZ);
        }
    }
}
